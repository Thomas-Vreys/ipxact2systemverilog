...
# with the command '/home/dev/Thomas-Vreys/fork_ipxact2systemverilog/ipxact2systemverilog/.venv/bin/ipxact2py --srcFile example/input/test.xml --destDir example/output_default -- config example/input/default.ini'
#
