...
# with the command '/home/def/.local/bin/ipxact2py --srcFile example/input/test.xml --destDir example/output_no_default'
#
...
class reg0_type(Register):
    ...
    def __init__(self, parent_ip, address_offset):
        super().__init__(parent_ip, address_offset)

        # [7:0]
        self._byte0 = IntegerField(self,
                                   bit_width=8,
                                   bit_offset=0,
                                   access='read-write',
                                   minimum=7,
...
class reg1_type(Register):
    def __init__(self, parent_ip, address_offset):
        ...
        # [31:0]
        self._field0 = IntegerField(self,
                                    bit_width=32,
                                    bit_offset=0,
                                    access='read-write',
                                    minimum=20,
...
class reg2_type(Register):
    ...
    def __init__(self, parent_ip, address_offset):
        ...
        self._power = IntegerField(self,
                                   ...
                                   maximum=None)
        # [1]
        self._power2 = IntegerField(self,
                                    bit_width=1,
                                    bit_offset=1,
                                    access='read-write',
                                    minimum=None,
                                    maximum=None)
        # [3:2]
        self._monkey = EnumField(self,
                                 bit_width=2,
                                 bit_offset=2,
                                 access='read-write',
                                 enum_type=monkey_enum)
        # [5:4]
        self._monkey2 = EnumField(self,
                                  bit_width=2,
                                  bit_offset=4,
                                  access='read-write',
                                  enum_type=monkey2_enum)
        # [7:6]
        self._monkey3 = EnumField(self,
                                  bit_width=2,
                                  bit_offset=6,
                                  access='read-write',
                                  enum_type=monkey3_enum)
        # [9:8]
        self._monkey4 = EnumField(self,
                                  bit_width=2,
                                  bit_offset=8,
                                  access='read-write',
                                  enum_type=monkey4_enum)
        # [31:10]
        self._unused0 = IntegerField(self,
                                     bit_width=22,
                                     bit_offset=10,
                                     access='read-write',
                                     minimum=None,
...
class reg7_type(Register):
    ...
    def __init__(self, parent_ip, address_offset):
        ...
        # [3:0]
        self._nibble0 = IntegerField(self,
                                     bit_width=4,
                                     bit_offset=0,
                                     access='read-write',
                                     minimum=None,
        ...
        self._unused0 = IntegerField(self,
                                     ...
                                     maximum=None)
        # [11:8]
        self._nibble1 = IntegerField(self,
                                     bit_width=4,
                                     bit_offset=8,
                                     access='read-write',
                                     minimum=None,
                                     maximum=None)
        # [15:12]
        self._unused1 = IntegerField(self,
                                     bit_width=4,
                                     bit_offset=12,
                                     access='read-write',
                                     minimum=None,
                                     maximum=None)
        # [19:16]
        self._nibble2 = IntegerField(self,
                                     bit_width=4,
                                     bit_offset=16,
                                     access='read-write',
                                     minimum=None,
                                     maximum=None)
        # [31:20]
        self._unused2 = IntegerField(self,
                                     bit_width=12,
                                     bit_offset=20,
                                     access='read-write',
                                     minimum=None,
...
class example_type(IP):
    def __init__(self, parent, base_address=0, access_layer=accesLayer):
